...
func (x *HelloResponse) GetNow() *timestamppb.Timestamp {
	if x != nil {
		return x.Now
	}
	return nil
...
var file_hello_world_proto_rawDesc = []byte{
	...
	0x6e, 0x61, 0x6d, 0x65, 0x22, 0x51, 0x0a, 0x0d, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x52, 0x65, 0x73,
	...
	0x6d, 0x70, 0x52, 0x03, 0x6e, 0x6f, 0x77, 0x32, 0x4e, 0x0a, 0x0c, 0x48, 0x65, 0x6c, 0x6c, 0x6f,
	...
	0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x63, 0x77, 0x78, 0x30, 0x31, 0x31, 0x37, 0x2f, 0x67, 0x72,
...
var file_hello_world_proto_depIdxs = []int32{
	2, // 0: helloworld.HelloResponse.now:type_name -> google.protobuf.Timestamp
	0, // 1: helloworld.HelloService.Hello:input_type -> helloworld.HelloRequest
	1, // 2: helloworld.HelloService.Hello:output_type -> helloworld.HelloResponse
